...
def checkpoint_path():
    ...
    """
    return os.getenv("ADAPTDL_CHECKPOINT_PATH", "/home/haifatl/Documents/alpa/alpa-adaptdl-feb11/alpa-adaptdl/examples/huggingface/transformers/examples/flax/BERT/adaptdl-checkpoints")
