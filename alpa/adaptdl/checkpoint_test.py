...
def test_duplicate():
    from alpa.adaptdl.env import num_restarts
    from alpa.adaptdl.checkpoint import State
...
def test_save_load():
    import pickle
    from alpa.adaptdl.checkpoint import State, save_all_states, load_state
    from alpa.adaptdl.env import replica_rank, num_restarts
    ...
    state_1 = TestState("state_1_")
    state_2 = TestState("state_2_")
