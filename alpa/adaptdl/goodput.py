...
#handler = logging.FileHandler(f"/home/haifatl/Documents/alpa/alpa-adaptdl-7/alpa-adaptdl/examples/huggingface/transformers/examples/flax/BERT/logs/Bert_goodput_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.log")
