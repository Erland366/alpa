...
from utils import monkeypatch_rope_gemma

monkeypatch_rope_gemma() # Need to monkeypatch Llama here!
...
def monkey_patch_remat():
    ...
    from transformers.models.gemma.modeling_flax_gemma import FlaxGemmaDecoderLayer, FlaxGemmaLayerCollection
    ...
    def setup(self):
        self.blocks = [
            remat(FlaxGemmaDecoderLayer, static_argnums=(2, 3, 4))(
    ...
    setattr(FlaxGemmaLayerCollection, "setup", setup)
    setattr(FlaxGemmaLayerCollection, "__call__", call)
...
def main():
    ...
    if not yml_config.profiling.get("enabled", False):
        ...
        pollux_agent.force_dataloader_localbatchsize = batch_sizes_to_run[0]s
