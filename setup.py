...
def locate_cuda():
    ...
    cudaconfig = {
        ...
        "lib64": os.path.join(
            cuda_home, os.path.join("lib", "x64") if IS_WINDOWS else "lib64"
        ),
    }
...
doc_require_list = ["sphinx", "sphinx-rtd-theme", "sphinx-gallery", "matplotlib"]
...
if __name__ == "__main__":
    ...
    setup(
        ...
        keywords=(
            "alpa distributed parallel machine-learning model-parallelism"
